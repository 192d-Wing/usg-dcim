...
import {
  LayoutDashboard, Building2, Server, Bell, Cpu, Gauge, LogOut, ChevronRight, Wrench, KeyRound, ScrollText, Upload, ShieldCheck, Network,
} from 'lucide-react';
...
const NAV: NavItem[] = [
  ...
  { to: '/ipam',       label: 'IPAM',       icon: Network, cap: 'inventory:read' },
