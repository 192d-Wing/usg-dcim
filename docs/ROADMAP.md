...
| IPAM polish | Supernet drag-and-drop reparent | We ship subnet drag-and-drop but not supernet → supernet moves. PATCH already supports `parent_supernet_id`; mostly a frontend wiring + cycle-prevention check. |
