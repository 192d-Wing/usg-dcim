...
CREATE INDEX IF NOT EXISTS ix_anycast_groups_fabric ON anycast_groups (fabric_id);
...
CREATE INDEX IF NOT EXISTS ix_bgp_peers_site ON bgp_peers (site_id);
...
CREATE INDEX IF NOT EXISTS ix_dns_zones_fabric ON dns_zones (fabric_id);
CREATE INDEX IF NOT EXISTS ix_dns_zones_site ON dns_zones (site_id);
...
CREATE INDEX IF NOT EXISTS ix_dns_records_zone_name_type ON dns_records (zone_id, name, type);
CREATE INDEX IF NOT EXISTS ix_dns_records_source ON dns_records (source);
CREATE INDEX IF NOT EXISTS ix_dns_records_ipam_address ON dns_records (ipam_address_id);
...
CREATE INDEX IF NOT EXISTS ix_dns_servers_site ON dns_servers (site_id);
CREATE INDEX IF NOT EXISTS ix_dns_servers_fabric ON dns_servers (fabric_id);
...
CREATE INDEX IF NOT EXISTS ix_anycast_bindings_server ON anycast_bgp_bindings (dns_server_id);
CREATE INDEX IF NOT EXISTS ix_anycast_bindings_peer ON anycast_bgp_bindings (bgp_peer_id);

-- +goose Down
DROP TABLE IF EXISTS anycast_bgp_bindings;
DROP TABLE IF EXISTS dns_servers;
DROP TABLE IF EXISTS dns_records;
DROP TABLE IF EXISTS dns_zones;
DROP TABLE IF EXISTS bgp_peers;
DROP TABLE IF EXISTS anycast_groups;
DROP TYPE IF EXISTS anycast_service;
DROP TYPE IF EXISTS dns_record_source;
DROP TYPE IF EXISTS dns_record_type;
DROP TYPE IF EXISTS dns_zone_kind;
DROP TYPE IF EXISTS dns_server_role;
